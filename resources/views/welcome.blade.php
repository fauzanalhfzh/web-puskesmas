                        ...
                        <div class="mb-4 text-blue-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mx-auto" fill="none"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M15 21v-1a6 6 0 00-5.197-5.803" />
                            </svg>
                        </div>
                        <h3 class="text-xl font-semibold mb-2">Poli Umum</h3>
                        <p class="text-gray-600">Layanan pemeriksaan kesehatan dasar dan penanganan penyakit umum.</p>
                    </div>
                    <div class="bg-white rounded-lg shadow-lg p-6 text-center">
                        <div class="mb-4 text-blue-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mx-auto" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M4.828 4.828a1 1 0 011.414 0L9 7.586a1 1 0 010 1.414L6.242 12a1 1 0 01-1.414 0L2 9.414a1 1 0 010-1.414l2.828-2.828zm10.586 10.586a1 1 0 01-1.414 0L12 16.414a1 1 0 010-1.414l2.758-2.758a1 1 0 011.414 0l2.828 2.828a1 1 0 010 1.414l-2.828 2.828zM4.828 15.414a1 1 0 011.414 0L9 18.242a1 1 0 010 1.414l-2.758 2.758a1 1 0 01-1.414 0L2 19.586a1 1 0 010-1.414l2.828-2.828zm10.586-10.586a1 1 0 01-1.414 0L12 7.586a1 1 0 010-1.414l2.758-2.758a1 1 0 011.414 0l2.828 2.828a1 1 0 010 1.414l-2.828 2.828z" />
                            </svg>
                        </div>
                        <h3 class="text-xl font-semibold mb-2">Poli Gigi</h3>
                        <p class="text-gray-600">Pemeriksaan dan perawatan kesehatan gigi dan mulut.</p>
                    </div>
                    <div class="bg-white rounded-lg shadow-lg p-6 text-center">
                        <div class="mb-4 text-blue-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mx-auto" fill="none"
                        ...
                        <h3 class="text-xl font-semibold mb-2">Poli KIA</h3>
                        <p class="text-gray-600">Layanan kesehatan untuk ibu hamil, persalinan, dan tumbuh kembang anak.
                        </p>
                    </div>
                </div>
            </div>
